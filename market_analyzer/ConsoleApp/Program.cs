...
builder.ConfigureServices((context, services) =>
{
    ...
    services.AddSingleton<IStrategy, StopAtrFollowTrend>();
    ...
    services.AddSingleton<IStrategy, VwapFollowTrend>();
    services.AddSingleton<IStrategy, Kama>();
    services.AddSingleton<IStrategy, KamaFollowTrend>();
    services.AddSingleton<IStrategy, HtTrendline>();
    services.AddSingleton<IStrategy, HtTrendlineFollowTrend>();
    services.AddSingleton<IStrategy, Mama>();
    services.AddSingleton<IStrategy, MamaFollowTrend>();
    services.AddSingleton<IStrategy, T3>();
    services.AddSingleton<IStrategy, T3FollowTrend>();
    services.AddSingleton<IStrategy, Alma>();
    services.AddSingleton<IStrategy, AlmaFollowTrend>();
    services.AddSingleton<IStrategy, Sma>();
    services.AddSingleton<IStrategy, SmaFollowTrend>();
    services.AddSingleton<IStrategy, Ema>();
    services.AddSingleton<IStrategy, EmaFollowTrend>();
    services.AddSingleton<IStrategy, Wma>();
    services.AddSingleton<IStrategy, WmaFollowTrend>();
    services.AddSingleton<IStrategy, Vwma>();
    services.AddSingleton<IStrategy, VwmaFollowTrend>();
    services.AddSingleton<IStrategy, Dema>();
    services.AddSingleton<IStrategy, DemaFollowTrend>();
    services.AddSingleton<IStrategy, Epma>();
    services.AddSingleton<IStrategy, EpmaFollowTrend>();
    services.AddSingleton<IStrategy, Hma>();
    services.AddSingleton<IStrategy, HmaFollowTrend>();
    services.AddSingleton<IStrategy, Smma>();
    services.AddSingleton<IStrategy, SmmaFollowTrend>();
    services.AddSingleton<IStrategy, Tema>();
    services.AddSingleton<IStrategy, TemaFollowTrend>();
