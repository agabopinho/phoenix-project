...
{
    public class InMemoryBacktestDatabaseProvider : IBacktestDatabaseProvider
    {
        private readonly IMarketDataWrapper _marketDataWrapper;
        private readonly IDatabase _database;
        private readonly ILogger<InMemoryBacktestDatabaseProvider> _logger;

        public InMemoryBacktestDatabaseProvider(IMarketDataWrapper marketDataWrapper, IDatabase database, ILogger<InMemoryBacktestDatabaseProvider> logger)
        {
